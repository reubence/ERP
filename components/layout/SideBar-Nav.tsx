...
const navigation = [
	...
	{ name: 'Ledger', href: '#', icon: LibraryIcon, current: false },
	{ name: 'Sales', href: '#', icon: CurrencyRupeeIcon, current: true },
	{ name: 'Purchase', href: '#', icon: ShoppingCartIcon, current: false },
	{ name: 'Payments', href: '#', icon: CashIcon, current: false },
	{ name: 'Inventory', href: '#', icon: ArchiveIcon, current: false },
